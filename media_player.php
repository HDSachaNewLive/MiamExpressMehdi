...
// PLAYLIST
const PLAYLIST = [
    { id: 'y-WCvqQm80o', title: 'J A L L O NㅤㅤT R I G G E R E D', channel: 'BOTCH Shorts (Fan)' },
    { id: 'nFzFusgOtFo', title: '⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀', channel: 'BOTCH Shorts (Fan)' },
    { id: 'fiJAYnG_lhM', title: 'Comment Bourdon débouche ses toilettes après avoir iech :', channel: 'BOTCH Shorts (Fan)' },
    { id: 'Z78y4-5alyU', title: 'NTE - Capital Doré (Maison) OST Extended', channel: 'BOTCH Shorts (Fan)' },
    { id: 'cssdQqVRUMY', title: "alexis note cette game que j'ai gagné avec cloud (j'ai joué au clavier au cas ou)", channel: 'BOTCH Shorts (Fan)' },
    { id: 'TPw0gNtBO6g', title: '⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀', channel: 'BOTCH Shorts (Fan)' },
    { id: 'ORhaXWHc77Y', title: 'B I G M A C B O U R D O N', channel: 'BOTCH Shorts (Fan)' },
    { id: 'FyJ45NMHUD0', title: 'ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ ㅤㅤㅤㅤㅤㅤ', channel: 'BOTCH Shorts (Fan)' },
    { id: 'FwHZJqxIewQ', title: '⠀⠀⠀⠀⠀⠀⠀⠀', channel: 'BOTCH Shorts (Fan)' },
    { id: 'rAlOyyFwdd4', title: 'Smash Bros avec Zachabian', channel: 'BOTCH Shorts (Fan)' },
